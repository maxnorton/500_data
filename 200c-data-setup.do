...
include "200c-datamgt.do"	// Set up data according to script.
include "datamgt-generate1970.do" 	// Output data file with all 1970 observations.
include "200c-datamgt-generate1965.do"	// Output data file with all 1965 observations.
include "datamgt-merge.do"			// Merge into 2-period data file, create state delta var.
include "200c-datamgt-marriage.do"		// Generate marriage vars.
