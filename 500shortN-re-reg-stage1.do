...
outreg2 [er_f occ_f sgl_f sei_f] using stage1-output-f, replace alpha(.02, .10, .20)  nonotes
...
outreg2 [er_f_noed occ_f_noed sgl_f_noed sei_f_noed] using stage1-output-f_noed, replace alpha(.02, .10, .20)  nonotes
