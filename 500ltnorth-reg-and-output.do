...
* MIGRANTS TO NORTH
	* ==MALE
		regress erscor50 MWithinNorth willMarryAtAll willMarryN MWithinMarrAAInt MWithinMarrNInt longtermN LTN_wMAA_i LTN_wMN_i tMWithinNorth tWMAA1 tWMN1 tMWithinMarrAAInt tMWithinMarrNInt LTN_tMWN_i LTN_tWMAA_i LTN_tWMN_i LTN_tMWN_tWMAA_i LTN_tMWN_tWMN_i time age agesqr education children state_inc_1965 deltaStateInc if MToNorth==1 & dSex==0, r
		ovtest
		est store er_n_m

		regress occscore_real MWithinNorth willMarryAtAll willMarryN MWithinMarrAAInt MWithinMarrNInt longtermN LTN_wMAA_i LTN_wMN_i tMWithinNorth tWMAA1 tWMN1 tMWithinMarrAAInt tMWithinMarrNInt LTN_tMWN_i LTN_tWMAA_i LTN_tWMN_i LTN_tMWN_tWMAA_i LTN_tMWN_tWMN_i time age agesqr education children state_inc_1965 deltaStateInc if MToNorth==1 & dSex==0, r
		ovtest
		est store occ_n_m
		
		regress presgl MWithinNorth willMarryAtAll willMarryN MWithinMarrAAInt MWithinMarrNInt longtermN LTN_wMAA_i LTN_wMN_i tMWithinNorth tWMAA1 tWMN1 tMWithinMarrAAInt tMWithinMarrNInt LTN_tMWN_i LTN_tWMAA_i LTN_tWMN_i LTN_tMWN_tWMAA_i LTN_tMWN_tWMN_i time age agesqr education children state_inc_1965 deltaStateInc if MToNorth==1 & dSex==0, r
		ovtest
		est store sgl_n_m

		regress sei MWithinNorth willMarryAtAll willMarryN MWithinMarrAAInt MWithinMarrNInt longtermN LTN_wMAA_i LTN_wMN_i tMWithinNorth tWMAA1 tWMN1 tMWithinMarrAAInt tMWithinMarrNInt LTN_tMWN_i LTN_tWMAA_i LTN_tWMN_i LTN_tMWN_tWMAA_i LTN_tMWN_tWMN_i time age agesqr education children state_inc_1965 deltaStateInc if MToNorth==1 & dSex==0, r
		ovtest
		est store sei_n_m
